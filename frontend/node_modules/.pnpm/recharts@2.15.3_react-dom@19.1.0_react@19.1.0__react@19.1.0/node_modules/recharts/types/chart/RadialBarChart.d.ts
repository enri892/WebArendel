export declare const RadialBarChart: import("react").ForwardRefExoticComponent<import("recharts/types/chart/generateCategoricalChart").CategoricalChartProps & import("react").RefAttributes<{
...
/recharts/types/chart/types").CategoricalChartState, K>, callback?: () => void): void;
    forceUpdate(callback?: () => void): void;
    readonly props: Readonly<import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/chart/generateCategoricalChart").CategoricalChartProps>;
    state: Readonly<import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/chart/types").CategoricalChartState>;
    refs: {
        [key: string]: import("react").ReactInstance;
    };
    shouldComponentUpdate?(nextProps: Readonly<import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/chart/generateCategoricalChart").CategoricalChartProps>, nextState: Readonly<import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/chart/types").CategoricalChartState>, nextContext: any): boolean;
    componentDidCatch?(error: Error, errorInfo: import("react").ErrorInfo): void;
    componentWillMount?(): void;
    UNSAFE_componentWillMount?(): void;
    componentWillReceiveProps?(nextProps: Readonly<import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/chart/generateCategoricalChart").CategoricalChartProps>, nextContext: any): void;
    UNSAFE_componentWillReceiveProps?(nextProps: Readonly<import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/chart/generateCategoricalChart").CategoricalChartProps>, nextContext: any): void;
    componentWillUpdate?(nextProps: Readonly<import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/chart/generateCategoricalChart").CategoricalChartProps>, nextState: Readonly<import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/chart/types").CategoricalChartState>, nextContext: any): void;
    UNSAFE_componentWillUpdate?(nextProps: Readonly<import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/chart/generateCategoricalChart").CategoricalChartProps>, nextState: Readonly<import(".pnpm/recharts@2.15.3_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/recharts/types/chart/types").CategoricalChartState>, nextContext: any): void;
}>>;
